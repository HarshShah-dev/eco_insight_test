...
from .serializers import AirQualityDataSerializer, EnergyDataSerializer, OccupancyDataSerializer, EMDataSerializer, RawSensorDataSerializer
...
class OccupancyDataBulkCreateView(APIView):
    permission_classes = [AllowAny]
